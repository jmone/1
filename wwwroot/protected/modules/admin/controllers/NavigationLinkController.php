...
class NavigationLinkController extends RController
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('NavigationLink');
	 ...
	 * @return NavigationLink the loaded model
	 ...
	 * @param NavigationLink $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='navigation-link-form')
		{
